...
function MainLayout() {
  return (
    <main className={clsx('my-4 text-slate-800', 'px-4 pb-16 md:px-[10vw] md:pb-0 lg:px-[15vw]')}>
      ...
      <hr />
      <Outlet />
      <div className='fixed bottom-0 left-0 z-50 h-16 w-full bg-gray-700 md:hidden'>
        <div className='mx-auto grid h-full max-w-lg grid-cols-2 justify-around font-medium text-gray-400'>
